...
본 프로젝트는 컴퓨터공학과 리눅스 프로그래밍 과목에서 ai를 사용하여 진행한 프로젝트로써 Django, PostgreSQL, Nginx, Docker Compose 구조를 사용하여 사용자의 요청이 웹 서버, 백엔드, 데이터베이스로 이어지는 전체 흐름을 이해하고 구현하는 것을 목표로 합니다.
